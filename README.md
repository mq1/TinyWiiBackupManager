...
| --- |
| ➡️ Download the `.dmg` |
| ⚠️ The app is not notarized, you must allow it manually after installing by running this command in Terminal:<br><br>`xattr -rd com.apple.quarantine /Applications/TinyWiiBackupManager.app` |
