...
//! Source: `GameTDB` (<https://www.gametdb.com>)

use phf::{Map, phf_map};

/// A comprehensive, compile-time map of Wii and `GameCube` game IDs to their English titles.
/// The data is sourced from `GameTDB` and includes official, homebrew, and prototype titles.
pub static GAME_TITLES: Map<&'static str, &'static str> = phf_map! {
    ...
    "DTOJ8P" => "428: Fuusa Sareta Shibuya de (Taikenban)",
    "DTZJ08" => "Takarajima Z Barbaros' Treasure (Demo)",
    "DWEJA4" => "Winning Eleven PLAY MAKER 2008 (Demo)",
    ...
    "R7MPFR" => "Musiic Party: Rock the House",
    ...
    "R8HZ4Q" => "Hannah Montana: The Movie",
    ...
    "RC2E78" => "Cars: Mater-National Championship",
    "RC2P78" => "Cars: Mater-National Championship",
    ...
    "RIAE52" => "Ice Age 3: Dawn of the Dinosaurs",
    ...
    "RIKEQH" => "Truck Racer",
    "RIKPNG" => "Truck Racer",
    "RILJ18" => "Puzzle Series Vol. 2: Illust Logic + Colorful Logic",
    ...
    "RMCJ51" => "Wiimms MKW-Fun 2023-09.jap",
    ...
    "RS4PH3" => "Castle of Shikigami III",
    ...
    "RTGJ18" => "Wi-Fi Taiou - Gensen Table Game Wii",
    ...
    "RU4P41" => "NewU Fitness First Personal Trainer",
    ...
    "RV9P78" => "Avatar: The Legend of Aang - Into the Inferno",
    "RVAE78" => "Avatar: The Last Airbender - The Burning Earth",
    "RVAP78" => "Avatar: The Legend of Aang - The Burning Earth",
    ...
    "S5DE41" => "Just Dance Disney Party 2",
    "S5DP41" => "Just Dance Disney Party 2",
    "S5EE41" => "Just Dance 2019",
    "S5EP41" => "Just Dance 2019",
    "S5KJAF" => "Taiko no Tatsujin Wii: Chou Goukaban",
    "S5MEVZ" => "Monster High: New Ghoul in School",
    "S5MPVZ" => "Monster High: New Ghoul in School",
    "S5PPAU" => "PSA World Tour Squash",
    "S5QJC8" => "Sengoku Musou 3 Moushouden",
    "S5RESZ" => "Ram Racing",
    "S5RPNJ" => "Ram Racing",
    ...
    "S7AKWR" => "LEGO Batman 2: DC Super Heroes",
    "S7AKZA" => "LEGO Batman 2: DC Super Heroes",
    ...
    "S7EE52" => "Transformers: Ultimate Battle Edition",
    "S7EP52" => "Transformers: Ultimate Battle Edition",
    "S7FE5G" => "Zumba Kids",
    "S7FPGT" => "Zumba Kids: The Ultimate Zumba Dance Party",
    "S7JPKM" => "Let's Sing 6 - Spanish Version",
    "S7KPKM" => "Let's Sing 2014",
    "S7LPKM" => "Let's Sing @ Radio Italia",
    "S7SP41" => "The Smurfs Party Pack",
    "SA3E5G" => "Alvin and the Chipmunks: Chipwrecked",
    "SA3P5G" => "Alvin and the Chipmunks: Chipwrecked",
    "SA3XGT" => "Alvin and the Chipmunks: Chipwrecked",
    ...
    "SAOXVZ" => "Monster High: Ghoul Spirit",
    ...
    "SB7IVU" => "Planet Basket 2009/2010",
    "SB8EQH" => "Burger Bot",
    ...
    "SCAP18" => "Calling",
    "SCBE5V" => "Cyberbike Cycling Sports",
    ...
    "SDUX41" => "The Smurfs Dance Party - Walmart Edition",
    ...
    "SE3E41" => "Just Dance 2015",
    "SE3P41" => "Just Dance 2015",
    ...
    "SH9PNJ" => "Heathcliff: The Fast and the Furriest",
    ...
    "SHVX78" => "Hot Wheels: Track Attack",
    ...
    "SI3P69" => "FIFA 12",
    "SI3X69" => "FIFA 12",
    "SIAE52" => "Ice Age 4: Continental Drift - Arctic Games",
    "SIAI52" => "Ice Age 4: Continental Drift: Arctic Games",
    ...
    "SJNE41" => "Just Dance 2016",
    "SJNP41" => "Just Dance 2016",
    "SJOE41" => "Just Dance 2014",
    "SJOP41" => "Just Dance 2014",
    "SJPE78" => "Jeopardy!",
    ...
    "SK8E52" => "Skylanders: Trap Team",
    "SK8I52" => "Skylanders: Trap Team",
    "SK8P52" => "Skylanders: Trap Team",
    "SK8V52" => "Skylanders: Trap Team",
    "SK8X52" => "Skylanders: Trap Team",
    ...
    "SKNE52" => "Skylanders: SuperChargers Racing",
    "SKNP52" => "Skylanders: SuperChargers Racing",
    ...
    "SL4PAF" => "Los 40 Principales Karaoke Party",
    "SL5DKM" => "Let's Sing 2019 - Mit Deutschen Hits!",
    "SL5FKM" => "Let's Sing 2019 : Hits Français et Internationaux",
    "SL6PGN" => "Everyone Sing",
    "SL7DML" => "2-in-1 - Meine Tierpension + Meine Tiersprechstunde",
    "SLAE78" => "The Last Airbender",
    "SLAP78" => "The Last Airbender",
    "SLAX78" => "The Last Airbender: Special Edition",
    "SLAZ78" => "The Last Airbender: Toys R Us Special Edition",
    ...
    "SLFPKM" => "Let's Sing",
    "SLFXKM" => "Let's Sing 5 - Spanish Version",
    "SLGEYG" => "Let's Sing 2016",
    "SLGPKM" => "Let's Sing 2016",
    ...
    "SP5E70" => "The Kore Gang: Outvasion From Inner Earth",
    ...
    "SQPPX4" => "Speed 2",
    "SQQEVZ" => "Disney Planes: Fire & Rescue",
    "SQQPVZ" => "Disney Planes: Fire & Rescue",
    "SQRPNG" => "We Sing Rock!",
    ...
    "SSQK01" => "Mario Party 9",
    "SSQP01" => "Mario Party 9",
    "SSQW01" => "Mario Party 9",
    ...
    "ST4XNX" => "Thomas & Friends: Hero of the Rails",
    ...
    "SV6SRV" => "The Voice",
    "SV7EVZ" => "Penguins of Madagascar",
    "SV7PVZ" => "Penguins of Madagascar",
    "SVBE52" => "Battleship",
    "SVBP52" => "Battleship",
    "SVCEPZ" => "Big Time Rush: Dance Party",
    "SVCPXT" => "Big Time Rush: Dance Party",
    "SVDE52" => "SpongeBob SquarePants: Plankton's Robotic Revenge",
    "SVDP52" => "SpongeBob SquarePants: Plankton's Robotic Revenge",
    "SVEPAF" => "DreamWorks The Croods: Prehistoric Party! & Rise of the Guardians: Combo Pack",
    "SVHE69" => "FIFA 14 - Legacy Edition",
    ...
    "SVPESZ" => "Vegas Party",
    "SVPPNJ" => "Vegas Party",
    "SVQEVZ" => "Barbie and Her Sisters: Puppy Rescue",
    "SVQPVZ" => "Barbie and Her Sisters: Puppy Rescue",
    "SVSPZX" => "Battle vs Chess",
    ...
    "SVXX52" => "Skylanders: Swap Force",
    "SVXY52" => "Skylanders: Swap Force",
    "SVYEG9" => "Ben 10: Omniverse 2",
    "SVYPAF" => "Ben 10: Omniverse 2",
    "SVZEVZ" => "How to Train Your Dragon 2",
    "SVZPVZ" => "How to Train Your Dragon 2",
    "SW2E52" => "Wipeout 2",
    "SW3EJJ" => "Winter Stars",
    "SW3PKM" => "Winter Stars",
    ...
    "SY7PKM" => "Let's Sing 7 - Spanish Version",
    "SY8PKM" => "Let's Sing 2015",
    "SZ2E5G" => "Zumba Fitness 2",
    "SZ2P5G" => "Zumba Fitness 2",
    "SZ2XGT" => "Zumba Fitness 2",
    "SZ3E5G" => "Zumba Fitness World Party",
    "SZ3PGT" => "Zumba Fitness World Party",
    "SZ5E5G" => "Zumba Fitness",
    "SZ5PGT" => "Zumba Fitness",
    "SZ7E41" => "Just Dance 2017",
    "SZ7P41" => "Just Dance 2017",
    "SZAE69" => "Rock Band 2",
    "SZAP69" => "Rock Band 2",
    "SZBE69" => "Rock Band 3",
    "SZBP69" => "Rock Band 3",
    ...
    "BIKE69" => "Bikmin 269 DX: Director's Cut",
    "BOWE01" => "New Super Mario Bros. Wii 17 Bowser's Last Laugh",
    "BRLEXJ" => "Fragile Dreams: Adeus às Ruínas da Lua",
    ...
    "C4AEE9" => "Harvest Moon: Magical Melody (Rainbow Version)",
    ...
    "CGHE52" => "Guitar Hero 2K16 (Custom)",
    ...
    "CS5P00" => "StarSing : '70s v2.3",
    "CS5PZZ" => "StarSing : Songs For My Jedi v1.0",
    "CS6P00" => "StarSing : Douce France v2.0",
    "CS6PZZ" => "StarSing : Amped Part. I v2.0",
    "CS7P00" => "StarSing : Red Hot Chili Peppers v1.0",
    "CS7PZZ" => "StarSing : Amped Part. II v2.0",
    "CS8P00" => "StarSing : '90s Volume 1 v2.0",
    "CS8PZZ" => "StarSing : Disco-Funk v1.0",
    "CS9P00" => "StarSing : '80s Volume 2 v2.2",
    "CS9PZZ" => "StarSing : Pop Hits 9 v1.0",
    "CSAP00" => "StarSing : '80s Volume 3 v2.2",
    "CSAPZZ" => "StarSing : Best of Goldman v1.0",
    "CSBP00" => "StarSing : '90s Volume 2 v2.2",
    "CSCP00" => "StarSing : Michael Jackson v2.2",
    "CSCPZZ" => "StarSing : Hottest Hits v2.0",
    "CSDP00" => "StarSing : Rocks! Volume 2 v2.0",
    "CSDPZZ" => "StarSing : Boy Bands Vs. Girl Bands v2.0",
    "CSEP00" => "StarSing : Pop Hits 5 v2.0",
    "CSFP00" => "StarSing : Pop Hits 6 v2.0",
    "CSGP00" => "StarSing : Chansons Magiques de Disney v2.0",
    "CSHP00" => "StarSing : Volume 2 v1.0",
    "CSIP00" => "StarSing : Pop Hits 7 v2.0",
    "CSJP00" => "StarSing : Après-Ski Party v2.0",
    "CSKP00" => "StarSing : ABBA v1.1",
    "CSLP00" => "StarSing : Queen v2.0",
    ...
    "CT8P00" => "StarSing : Disco-Funk v2.1",
    "CT9P00" => "StarSing : Pop Hits 9 v2.0",
    "CTAP00" => "StarSing : Best of Goldman v2.0",
    "CTBP00" => "StarSing : Glee Volume 3 v1.0",
    ...
    "CTMP00" => "StarSing : Shakira v1.2",
    "CTNP00" => "StarSing : Pop Hits 10 v2.0",
    "CTOP00" => "StarSing : The Beatles Volume 2 v2.1",
    "CTPP00" => "StarSing : Motown v2.0",
    "CTQP00" => "StarSing : Glee Volume 2 v1.0",
    "CTRP00" => "StarSing : International Volume 1 v1.0",
    "CTSP00" => "StarSing : International Volume 2 v1.0",
    "CTTP00" => "StarSing : '80s Volume 4 v2.0",
    "CTUP00" => "StarSing : Rihanna v2.0",
    "CTVP00" => "StarSing : Lady GaGa v1.1",
    "CTWP00" => "StarSing : '90s Volume 3 v1.0",
    "CTXP00" => "StarSing : Retro Volume 1 v1.0",
    "CTYP00" => "StarSing : Retro Volume 2 v1.0",
    "CTZP00" => "StarSing : Volume 3 v1.0",
    "CU0P00" => "StarSing : Retro Volume 3 v1.0",
    "CU1P00" => "StarSing : Girls v1.0",
    "CU2P00" => "StarSing : Volume 4 v1.1",
    "CU3P00" => "StarSing : Retro Volume 4 v1.1",
    "CU4P00" => "StarSing : Retro Volume 5 v1.0",
    "CU5P00" => "StarSing : International Volume 4 v1.0",
    "CU6P00" => "StarSing : Volume 5 v1.0",
    "CU7P00" => "StarSing : Retro Volume 6 v1.0",
    "CU8P00" => "StarSing : Volume 6 v1.0",
    ...
    "GAYE41" => "Just Pride",
    "GBIK08" => "Biohazard",
    "GC4EBN" => "Shinseiki GPX Cyber Formula Road to the EVOLUTION",
    "GCDK08" => "Biohazard Code: Veronica Complete",
    "GCREBM" => "Xeno Crisis",
    "GCRJBM" => "Xeno Crisis",
    "GCRPBM" => "Xeno Crisis",
    "GDPEAF" => "Mr. Driller: Drill Land",
    ...
    "GPZE01" => "Nintendo Puzzle Collection",
    "GSME01" => "Super Mario 128",
    "GTDE01" => "Super Smash Bros. Melee: TurboDX",
    ...
    "J24E41" => "Just Dance 2024 Edition",
    "J4EE41" => "Just Dance 2024 Edition",
    "J5EE41" => "Just Dance 2025 Edition",
    "JF3E41" => "Just Dance Focus 3",
    "JONE52" => "Angry Birds Trilogy but with more Levels!",
    ...
    "KMNJ03" => "Newer Super Mario Bros. Wii",
    ...
    "PCLE01" => "Pikmin 2 Caveless Edition",
    ...
    "RMCE05" => "Wiimms MKW Fun 2010-12.p",
    ...
    "RMCE23" => "Wiimms MKW Fun 2014-01.ntsc",
    "RMCE24" => "Wiimms MKW Retro 2014-02.ntsc",
    "RMCE25" => "Wiimms MKW Fun 2014-04.ntsc",
    "RMCE26" => "Wiimms MKW Fun 2014-11.ntsc",
    "RMCE27" => "Wiimms MKW-Fun 2015-03.ntsc",
    "RMCE28" => "Wiimms MKW Retro 2015-05.ntsc",
    "RMCE29" => "Wiimms MKW-Fun 2015-08.ntsc",
    "RMCE30" => "Wiimms MKW-Fun 2015-12.ntsc",
    "RMCE31" => "Wiimms MKW-Fun 2016-02.ntsc",
    "RMCE32" => "Wiimms MKW-Fun 2016-07.ntsc",
    "RMCE33" => "Wiimms MKW-Fun 2016-10.usa",
    "RMCE34" => "Wiimms MKW-Fun 2017-05.usa",
    "RMCE35" => "Wiimms MKW-Fun 2017-12.usa",
    ...
    "RMCE51" => "Wiimms MKW-Fun 2023-09.usa",
    ...
    "RMCE75" => "Cam, Tom and Troy's CTGP Pack",
    "RMCE76" => "Pro CT Pack",
    ...
    "RMCEMP" => "Bowser498's MK8 HNS Pack",
    ...
    "RMCEOA" => "Chaotic Kart Wii",
    "RMCEOR" => "Bored Kart Wii",
    ...
    "RMCJ32" => "Wiimms MKW-Fun 2016-07.jap",
    "RMCJ33" => "Wiimms MKW-Fun 2016-10.jap",
    "RMCJ34" => "Wiimms MKW-Fun 2017-05.jap",
    "RMCJ35" => "Wiimms MKW-Fun 2017-12.jap",
    ...
    "RMCK51" => "Wiimms MKW-Fun 2023-09.kor",
    ...
    "RMCP19" => "Wiimms MKW Fun 2012-12.pal",
    "RMCP20" => "Wiimms MKW Fun 2013-04.pal",
    "RMCP21" => "Wiimms MKW Fun 2013-09.pal",
    "RMCP22" => "Wiimms MKW Fun 2013-10.pal",
    "RMCP23" => "Wiimms MKW Fun 2014-01.pal",
    "RMCP24" => "Wiimms MKW Retro 2014-02.pal",
    "RMCP25" => "Wiimms MKW Fun 2014-04.pal",
    "RMCP26" => "Wiimms MKW Fun 2014-11.pal",
    "RMCP27" => "Wiimms MKW-Fun 2015-03.pal",
    "RMCP28" => "Wiimms MKW Retro 2015-05.pal",
    "RMCP29" => "Wiimms MKW-Fun 2015-08.pal",
    "RMCP30" => "Wiimms MKW-Fun 2015-12.pal",
    "RMCP31" => "Wiimms MKW-Fun 2016-02.pal",
    "RMCP32" => "Wiimms MKW-Fun 2016-07.pal",
    "RMCP33" => "Wiimms MKW-Fun 2016-10.pal",
    "RMCP34" => "Wiimms MKW-Fun 2017-05.pal",
    "RMCP35" => "Wiimms MKW-Fun 2017-12.pal",
    "RMCP36" => "Wiimms MKW-Fun 2018-03.pal",
    "RMCP37" => "Wiimms MKW-Fun 2018-06.pal",
    "RMCP38" => "Wiimms MKW-Fun 2018-09.pal",
    "RMCP39" => "Wiimms MKW-Fun 2018-12.pal",
    ...
    "RMCP51" => "Wiimms MKW-Fun 2023-09.pal",
    ...
    "RMCPA2" => "Mario Kart Wii Deluxe -Blue Edition-",
    "RMCPAS" => "Mario Kart All-Stars",
    "RMCPBR" => "Mario Kart Brown",
    "RMCPCA" => "Mario Kart Wii [CAT]",
    "RMCPG2" => "Mario Kart Wii CTGP Revolution",
    "RMCPGP" => "Mario Kart CTGP Revolution",
    "RMCPIK" => "Insane Kart Wii",
    ...
    "RSBE03" => "Super Smash Bros. Brawl DX",
    "RSBE04" => "Super Smash Bros. Project M+",
    "RSBE05" => "Super Smash Bros. Project M Patt Edition",
    "RSBE06" => "Darkon360's Brawl Hack Pack",
    "RSBE07" => "Super Smash Bros. Project M: Theytah's Custom Build",
    "RSBE08" => "Marlan Project M 3.6",
    "RSBE09" => "Springboy64's Brawl Hack Pack",
    "RSBE10" => "Brawl Ying Yang Edition",
    "RSBE11" => "Professor MGW's Tournament Hack Pack #1",
    "RSBE12" => "Professor MGW's Tournament Hack Pack #2",
    "RSBE13" => "Professor MGW's Hack Pack #3",
    "RSBE14" => "Super Smash Bros. Brawl- Zeus",
    "RSBE15" => "Super Smash Bros. Brawl Minus Mugen",
    "RSBE16" => "Super Smash Bros. Brawl Shock",
    "RSBE17" => "Super Smash Bros. Brawl - Battlefield Build",
    "RSBE18" => "Super Smash Bros. Project M: Tournament Hack Pack",
    "RSBE19" => "Super Smash Bros. Project M: Fully Dressed Edition",
    "RSBE20" => "Pikezer's BrawlEx Pack",
    "RSBE21" => "Calabrel's Custom Project M Build",
    "RSBE22" => "Project M: Rage83's Competitive Custom Build",
    "RSBE23" => "Super Smash Bros. Project M: Justice Build",
    "RSBE24" => "Super Smash Bros. 3",
    "RSBE25" => "Super Smash Bros. Red Version",
    "RSBE26" => "Super Smash Bros. Silver",
    "RSBE27" => "Springboy64's Super Smash Bros. Brawl Hack Pack",
    "RSBE28" => "SuperYoshiStar's Super Smash Bros. Brawl Hack Pack",
    "RSBE29" => "Super Smash Bros. Project M: YoeiX Custom Build",
    "RSBE30" => "Super Smash Bros. Project M: Arko's Loaded Custom Build",
    "RSBE31" => "Super Smash Bros. Project M: Arko's Tournament Custom Build",
    "RSBE32" => "Super Smash Bros. Project M: Sempai's Build",
    "RSBE33" => "Super Smash Bros. Brawl Yin Yang Edition 2: The Balance of Kyu",
    "RSBE34" => "Super Smash Bros. Project U: Blue Version",
    "RSBE35" => "Super Smash Bros. Brawl Legacy: Project M",
    "RSBE36" => "Super Smash Bros. Project Best",
    "RSBE37" => "Super Smash Bros. Project M: Psycho Ghost's Build",
    "RSBE38" => "Super Smash Sisters Generations 2",
    "RSBE39" => "Super Smash Bros. Ultra Project M",
    "RSBE40" => "Super Smash Bros. Project M: Ragnarok Edition",
    "RSBE41" => "Super Smash Bros. Project M: Calabrel's Custom Build",
    "RSBE42" => "Super Smash Bros. Project M: RedX Anime/Game Custom Build",
    "RSBE43" => "Super Smash Bros. Brawl: MASTERLINKX's Custom Pack",
    "RSBE44" => "Super Smash Bros. Brawl: Shadow Version",
    "RSBE45" => "Super Smash Bros. Brawl: Shock44's Custom Build",
    "RSBE46" => "Super Smash Bros. Brawl: DragonD101's Texture Pack",
    "RSBE47" => "Super Smash Bros. Brawl: XChosen1's Texture Pack",
    "RSBE49" => "Super Smash Bros. Brawl: Water Block Edition",
    "RSBE50" => "Super Smash Bros. Project U: Ultra Version",
    "RSBEAA" => "Marvel and Capcom vs Super Smash Bros.",
    "RSBEBB" => "Super Smash Bros. Balanced Brawl",
    "RSBEBM" => "Super Smash Bros. Brawl Minus",
    "RSBEBP" => "Super Smash Bros. Brawl Plus",
    ...
    "RZDPCA" => "The Legend of Zelda: Twilight Princess (Catalan Translation)",
    ...
    "S24E41" => "Just Dance 2024: Wii Edition",
    "S25E41" => "Just Dance 2025 Wii: FurryTrash23 Edition",
    ...
    "SB4E24" => "Super Mario Galaxy 2 Cosmos Collapse",
    ...
    "SCLE01" => "Cliff Super Mario Bros. Wii",
    ...
    "SISLIP" => "StarSing : Linkin Park v2.0",
    ...
    "SM6E01" => "Super Mario 64 GameCube",
    ...
    "SMMP02" => "Super Mario: Mushroom Adventure PLUS: Winter Moon",
    "SMNC01" => "New Super Mario Bros. Wii",
    "SMNE02" => "New Super Mario Remake",
    "SMNE03" => "Newer Super Mario Bros. Wii",
    "SMNE04" => "Cannon Super Mario Bros. Wii",
    "SMNE05" => "Another Super Mario Bros. Wii",
    "SMNE06" => "Newer Summer Sun",
    ...
    "SMNE37" => "New Super Mario Bros. Wii Dragon Coaster Frenzy",
    "SMNE38" => "New Super Mario Bros. Wii Underground Maze",
    "SMNE39" => "Newer Super Mario Bros. Wii: Antnee Level Pack",
    "SMNE40" => "Newer Super Mario Bros. Wii U",
    "SMNE41" => "Devil Mario Winter Special",
    "SMNE42" => "New Super Mario Bros. Wii: Yoshi Mode Lite",
    "SMNE44" => "Go Go Mario",
    "SMNE45" => "Lemmy's Winter Palace",
    "SMNE46" => "New Super Mario Bros. Wii - Birthday Batch of Levels",
    "SMNE47" => "The New Special Road",
    "SMNE48" => "True Mario Bros.",
    "SMNE49" => "New Super Mario Bros. Wii - MSMKW Pack",
    "SMNE50" => "New Super Mario Bros. Wii - Power Tower Pack",
    "SMNE51" => "New Super Mario Bros. Wii - The Depot Level Pack Part 1",
    "SMNE52" => "New Super Mario Bros. Wii  - The Depot Level Pack Part 2",
    "SMNE53" => "New Super Mario Bros. Wii - Kid Edition",
    "SMNE54" => "New Super Mario Bros. Wii - The Next Levels 2",
    "SMNE55" => "New Super Mario Bros. Wii - Lava Mod Pack",
    "SMNE56" => "New Super Mario Bros. Wii - The Depot Level Pack Part 3",
    "SMNE57" => "Mario's Big Adventure",
    "SMNE58" => "Wario's Cave",
    "SMNE59" => "New Super Mario Bros. Wii - Quenry17's Level Pack",
    ...
    "SMNEMG" => "Mario's Midnight Adventure",
    ...
    "SMNEMY" => "Mario and the Mysterious Meteorite",
    ...
    "SMNEOY" => "Super Mario Snowy Season",
    "SMNEPC" => "New Super Mario Bros. Wii: The Prankster Comets",
    ...
    "SMNESR" => "Super Luigi Seasonal Shore",
    "SMNESS" => "New Super Mario Bros. 7",
    "SMNESU" => "Sunny Super Mario Bros. Wii",
    "SMNESW" => "Snowy Super Luigi Wii",
    ...
    "SMNEYM" => "You Super Mario Bros. Me Summer Special",
    "SMNEZA" => "Newer Apocalypse",
    "SMNEZC" => "Challenging Super Mario Bros. Wii: Virtual Special",
    "SMNEZD" => "Depot Super Mario Bros. Wii 2: The Lost Levels",
    "SMNEZN" => "Mario and the Glow Blocks",
    "SMNEZO" => "Ludwig's Hotel",
    "SMNEZP" => "The Pit of 100 Trials 1-20",
    "SMNEZT" => "Captain Bowser's Revenge",
    "SMNEZU" => "Duck Tales 3",
    "SMNEZV" => "Release Super Mario Bros. Wii",
    "SMNEZW" => "Depot Super Mario Bros. Wii",
    "SMNEZY" => "Super Mario Skyland",
    "SMNJ02" => "Awesomer Super Luigi Mini",
    "SMNJ03" => "Newer Super Mario Bros. Wii",
    "SMNJ04" => "Cannon Super Mario Bros. Wii",
    "SMNJ06" => "Newer Summer Sun",
    "SMNJ07" => "Newer Holiday Special",
    "SMNJ08" => "Epic Super Bowser World",
    "SMNJ10" => "Koopa Country",
    "SMNJ11" => "New Super Mario Bros. Wii 4",
    "SMNJ14" => "New Super Mario Bros. Wii: Pain Coins",
    "SMNJ15" => "Newer Super Mario Bros. 7",
    "SMNJ20" => "New Super Mario Bros. H",
    "SMNJ23" => "Newer Super Mario Bros. Wii: Falling Leaves",
    "SMNJ31" => "New Super Mario Bros. Wii - Other World",
    "SMNJ34" => "New Super Mario Bros. Wii: Yoshi Mode",
    "SMNJ35" => "New Super Mario Bros. Wii: Yoshi Mode - Classic Mode",
    "SMNJ36" => "New Super Mario Bros. Wii Hack Pack",
    "SMNJ37" => "New Super Mario Bros. Wii Dragon Coaster Frenzy",
    "SMNJ38" => "New Super Mario Bros. Wii Underground Maze",
    "SMNJ39" => "Newer Super Mario Bros. Wii: Antnee Level Pack",
    "SMNJ40" => "Newer Super Mario Bros. Wii U",
    "SMNJ41" => "Devil Mario Winter Special",
    "SMNJ42" => "New Super Mario Bros. Wii: Yoshi Mode Lite",
    "SMNJ44" => "Go Go Mario",
    "SMNJ45" => "Lemmy's Winter Palace",
    "SMNJ46" => "New Super Mario Bros. Wii - Birthday Batch of Levels",
    "SMNJ47" => "The New Special Road",
    "SMNJ48" => "True Mario Bros.",
    "SMNJ49" => "New Super Mario Bros. Wii - MSMKW Pack",
    "SMNJ50" => "New Super Mario Bros. Wii - Power Tower Pack",
    "SMNJ51" => "New Super Mario Bros. Wii - The Depot Level Pack Part 2",
    "SMNJ52" => "New Super Mario Bros. Wii - The Depot Level Pack Part 2",
    "SMNJ53" => "New Super Mario Bros. Wii - Kid Edition",
    "SMNJ54" => "New Super Mario Bros. Wii - The Next Levels 2",
    "SMNJ55" => "New Super Mario Bros. Wii - Lava Mod Pack",
    "SMNJ56" => "New Super Mario Bros. Wii - The Depot Level Pack Part 3",
    "SMNJ57" => "Mario's Big Adventure",
    "SMNJ58" => "Wario's Cave",
    "SMNJ59" => "New Super Mario Bros. Wii - Quenry17's Level Pack",
    "SMNJ60" => "Remixed Super Mario Bros. Wii",
    "SMNJ61" => "New Super Summer Vacation",
    "SMNJ62" => "New Super Bowser Wii",
    "SMNJ65" => "Ghostly Super Ghost Boos Wii",
    "SMNJ66" => "The Legend of Yoshi",
    "SMNJ67" => "Larsenv Super Mario Collection",
    "SMNJ68" => "The Legend of Yoshi DLC",
    "SMNJLL" => "Newer Super Luigi Wii",
    "SMNJLM" => "Newer Super Luigi Wii Dark Moon",
    "SMNJMI" => "Midi's Super Mario Bros. Wii Just A Little Adventure",
    "SMNJRE" => "Retro Mario Bros.",
    "SMNJRV" => "RVLution Wii",
    "SMNJXD" => "Deluxe Super Mario Bros. Wii",
    "SMNJXR" => "Super Mario Remix",
    "SMNJYE" => "8Forrest's Super Mario Bros. Wii",
    "SMNJYL" => "Luigi's Super Yoshi Bros.",
    "SMNJYM" => "You Super Mario Bros. Me Summer Special",
    "SMNJZA" => "Newer Apocalypse",
    "SMNJZC" => "Challenging Super Mario Bros. Wii: Virtual Special",
    "SMNJZD" => "Depot Super Mario Bros. Wii 2: The Lost Levels",
    "SMNJZN" => "Mario and the Glow Blocks",
    "SMNJZO" => "Ludwig's Hotel",
    "SMNJZP" => "The Pit of 100 Trials 1-20",
    "SMNJZT" => "Captain Bowser's Revenge",
    "SMNJZU" => "Duck Tales 3",
    ...
    "SMNP05" => "Another Super Mario Bros. Wii",
    "SMNP06" => "Newer Summer Sun",
    "SMNP07" => "Newer Holiday Special",
    "SMNP08" => "Epic Super Bowser World",
    "SMNP10" => "Koopa Country",
    "SMNP11" => "New Super Mario Bros. Wii 4",
    "SMNP12" => "Awesomer Super Luigi Mini",
    "SMNP14" => "New Super Mario Bros. Wii: Pain Coins",
    ...
    "SMNP36" => "New Super Mario Bros. Wii Hack Pack",
    "SMNP37" => "New Super Mario Bros. Wii Dragon Coaster Frenzy",
    "SMNP38" => "New Super Mario Bros. Wii Underground Maze",
    "SMNP39" => "Newer Super Mario Bros. Wii: Antnee Level Pack",
    "SMNP40" => "Newer Super Mario Bros. Wii U",
    "SMNP41" => "Devil Mario Winter Special",
    "SMNP42" => "New Super Mario Bros. Wii: Yoshi Mode Lite",
    "SMNP44" => "Go Go Mario",
    "SMNP45" => "Lemmy's Winter Palace",
    "SMNP46" => "New Super Mario Bros. Wii - Birthday Batch of Levels",
    "SMNP47" => "The New Special Road",
    "SMNP48" => "True Mario Bros.",
    "SMNP49" => "New Super Mario Bros. Wii - MSMKW Pack",
    "SMNP50" => "New Super Mario Bros. Wii - Power Tower Pack",
    "SMNP51" => "New Super Mario Bros. Wii - The Depot Level Pack Part 1",
    "SMNP52" => "New Super Mario Bros. Wii - The Depot Level Pack Part 2",
    "SMNP53" => "New Super Mario Bros. Wii - Kid Edition",
    "SMNP54" => "New Super Mario Bros. Wii - The Next Levels 2",
    "SMNP55" => "New Super Mario Bros. Wii - Lava Mod Pack",
    "SMNP56" => "New Super Mario Bros. Wii - The Depot Level Pack Part 3",
    "SMNP57" => "Mario's Big Adventure",
    "SMNP58" => "Wario's Cave",
    "SMNP59" => "New Super Mario Bros. Wii - Quenry17's Level Pack",
    "SMNP60" => "Remixed Super Mario Bros. Wii",
    "SMNP61" => "New Super Summer Vacation",
    "SMNP62" => "New Super Bowser Wii",
    "SMNP65" => "Ghostly Super Ghost Boos Wii",
    "SMNP66" => "The Legend of Yoshi",
    "SMNP67" => "Larsenv Super Mario Collection",
    "SMNP68" => "The Legend of Yoshi DLC",
    ...
    "SMNPPC" => "New Super Mario Bros. Wii: The Prankster Comets",
    ...
    "SMNPYL" => "Luigi's Super Yoshi Bros.",
    "SMNPYM" => "You Super Mario Bros. Me Summer Special",
    "SMNPZA" => "Newer Apocalypse",
    "SMNPZC" => "Challenging Super Mario Bros. Wii: Virtual Special",
    "SMNPZD" => "Depot Super Mario Bros. Wii 2: The Lost Levels",
    "SMNPZN" => "Mario and the Glow Blocks",
    "SMNPZO" => "Ludwig's Hotel",
    "SMNPZP" => "The Pit of 100 Trials 1-20",
    "SMNPZT" => "Captain Bowser's Revenge",
    "SMNPZU" => "Duck Tales 3",
    "SMNPZV" => "Release Super Mario Bros. Wii",
    "SMNPZW" => "Depot Super Mario Bros. Wii",
    "SMNPZY" => "Super Mario Skyland",
    ...
    "SMVE01" => "Super Mario Vacation",
    "SMVJ01" => "Super Mario Vacation",
    "SMVP01" => "Super Mario Vacation",
    "SMWE01" => "Newer Super Mario World U",
    "SMWJ01" => "Newer Super Mario World U",
    "SMWP01" => "Newer Super Mario World U",
    "SMXE41" => "Just Dance Maximum",
    ...
    "SOLE41" => "Just Dance Solo",
    "SOLO41" => "Just Dance Solo",
    "SOME02" => "Rhythm Heaven Fever Repainted",
    "SOMR01" => "Beat the Beat: Rhythm Paradise",
    ...
    "WSAE64" => "Pikmin 2 New Year (US)",
    "WSAP64" => "Pikmin 2 New Year (PAL)",
    ...
    "YELEDT" => "Pikmin 2 Yellow Edition",
    "ZM7E52" => "Call of Duty - Modern Warfare - Reflex Edition - Zombie Mode",
    "ZXFP52" => "Guitar Hero 3 Encore",
    "DC8A" => "Line Attack Heroes",
    "HDMD" => "Dr. Mario & Bazillenjagd (Beta)",
    "HDME" => "Dr. Mario Online Rx (Beta)",
    "HDMF" => "Dr. Mario & Bactericide (Beta)",
    "HDMI" => "Dr. Mario & Sterminavirus (Beta)",
    "HDMJ" => "Dr. Mario & Saikin Bokumetsu (Beta)",
    "HDMP" => "Dr. Mario & Germ Buster (Beta)",
    "HDMS" => "Dr. Mario & Bactericida (Beta)",
    "W22E" => "Planet Fish",
    "W24E" => "2 Fast 4 Gnomz",
    "W24P" => "2 Fast 4 Gnomz",
    "W2AE" => "Big Bass Arcade",
    ...
    "W4KE" => "Deer Captor",
    "W4KJ" => "Shika Gari",
    "W4OJ" => "Shikakui Atama wo Maru Kusuru - Mainichi Minna de Challenge Hen",
    ...
    "W82J" => "Jintori Action! Taikoukenchi - Karakuri Jo no Nazo",
    "W8BP" => "Babel Rising",
    "W8CE" => "Bit. Trip Core",
    ...
    "WB5J" => "Block Breaker Deluxe",
    "WB5P" => "Block Breaker Deluxe",
    "WB6E" => "TV Show King",
    "WB6J" => "TV Show King",
    "WB6P" => "TV Show King",
    "WB7E" => "Midnight Pool",
    "WB7J" => "Hamaru Billiards",
    "WB7P" => "Midnight Pool",
    ...
    "WOGJ" => "Okiraku Putter Golf Wii",
    "WOGP" => "Family Mini Golf",
    "WOKJ" => "Karaoke Joysound Wii",
    "WOLJ" => "Othello",
    "WOMJ" => "Sekai no Omoshiro Party Game 2",
    "WOPE" => "Word Searcher Deluxe",
    "WOSE" => "Family Slot Car Racing",
    "WOSJ" => "Okiraku Slot Car Racing Wii",
    ...
    "WSME" => "Eat! Fat! FIGHT!",
    "WSMJ" => "Tsuppari Oozumou Wii Beya",
    "WSMP" => "Eat! Fat! FIGHT!",
    ...
    "XH3E" => "Frobot (Demo)",
    "XH4E" => "Max and the Magic Marker (Demo)",
    "XH4P" => "Max & the Magic Marker (Demo)",
    "XH5E" => "Ayim And Yet It Moves (Demo)",
    "XH5P" => "And Yet It Moves (Demo)",
    "XH6E" => "Robox (Demo)",
    "XH6P" => "Robox (Demo)",
    "XH7E" => "Lit (Demo)",
    "XH7P" => "Lit (Demo)",
    "XH8E" => "Lead the Meerkats (Demo)",
    "XH8P" => "Lead the Meerkats (Demo)",
    "XH9P" => "ColorZ (Demo)",
    ...
    "XHLE" => "Jett Rocket (Demo)",
    "XHLP" => "Jett Rocket (Demo)",
    "XHME" => "Art of Balance (Demo)",
    "XHMP" => "Art of Balance (Demo)",
    "XHNP" => "Chronos Twins DX (Demo)",
    "XHOP" => "Art of Balance (Demo)",
    "XHQE" => "Zombie Panic (Demo)",
    "XHQP" => "Zombie Panic (Demo)",
    "XHRE" => "Furry Legends (Demo)",
    "XHRP" => "Furry Legends (Demo)",
    "XHVE" => "BIT.TRIP CORE (Demo)",
    "XHVP" => "BIT.TRIP CORE (Demo)",
    "XHWE" => "BIT.TRIP VOID (Demo)",
    "XHWP" => "BIT.TRIP VOID (Demo)",
    "XHXE" => "BIT.TRIP RUNNER (Demo)",
    "XHXP" => "BIT.TRIP RUNNER (Demo)",
    "XHYE" => "BIT.TRIP FATE (Demo)",
    "XHYP" => "BIT.TRIP FATE (Demo)",
    "XHZE" => "Chronos Twins DX (Demo)",
    ...
    "XIHE" => "Gladiator (Demo)",
    "XIHP" => "Gladiator (Demo)",
    "XIJE" => "Fast Racing League (Demo)",
    "XIJP" => "FAST - Racing League (Demo)",
    "XIKE" => "Monsteca Corral (Demo)",
    "XIKP" => "Monsteca Corral (Demo)",
    "XIMP" => "HoopWorld: BasketBrawl (Demo)",
    "XINE" => "Learning with the Pooyoos Episode 1 (Demo)",
    "XINP" => "Learning with the Pooyoos Episode 1 (Demo)",
    "XIOE" => "Learning with the Pooyoos Episode 2 (Demo)",
    "XIOP" => "Learning with the Pooyoos Episode 2 (Demo)",
    "XIPE" => "Learning with the Pooyoos Episode 3 (Demo)",
    "XIPP" => "Learning with the Pooyoos Episode 3 (Demo)",
    "XIQE" => "Dart Rage (Demo)",
    "XIRE" => "Pong Toss Pro (Demo)",
    "XISE" => "BIT.TRIP FLUX (Demo)",
    "XISP" => "BIT.TRIP FLUX (Demo)",
    "XITE" => "Fast Draw (Demo)",
    "XITP" => "Fast Draw (Demo)",
    "XIUE" => "Soccer Bashi (Demo)",
    ...
    "XJDE" => "MotoHeroz (Demo)",
    "XJDP" => "MotoHeroz (Demo)",
    "XJEE" => "Aya and the Cubes of Light (Demo)",
    "XJEP" => "Aya and the Cubes of Light (Demo)",
    "XJFP" => "ANIMA Ark of Sinners (Demo)",
    "XJGE" => "Gnomz (Demo)",
    "XJGP" => "Gnomz (Demo)",
    ...
    "FACJ" => "Pinball",
    "FACP" => "Pinball",
    "FADJ" => "Gomoku Narabe Renju",
    "FAFE" => "Mario Bros.",
    "FAFJ" => "Mario Bros.",
    "FAFP" => "Mario Bros.",
    "FAFQ" => "Mario Bros.",
    "FAGE" => "Super Mario Bros.",
    "FAGJ" => "Super Mario Bros.",
    "FAGP" => "Super Mario Bros.",
    "FAGQ" => "Super Mario Bros.",
    "FAHE" => "Tennis",
    "FAHJ" => "Tennis",
    "FAHP" => "Tennis",
    "FAIE" => "Soccer",
    ...
    "FAKJ" => "Zelda no Densetsu",
    "FAKP" => "The Legend of Zelda",
    "FAKT" => "The Legend of Zelda",
    "FALE" => "Baseball",
    "FALJ" => "Baseball",
    "FALP" => "Baseball",
    "FAME" => "Wario's Woods",
    ...
    "FATJ" => "Kage no Densetsu",
    "FAVE" => "Tecmo Bowl",
    "FAVJ" => "Tecmo Bowl",
    "FAWE" => "Elevator Action",
    "FAWJ" => "Elevator Action",
    "FAXE" => "Pac-Man",
    "FAXJ" => "Pac-Man",
    "FAXP" => "Pac-Man",
    "FAXT" => "Pac-Man",
    ...
    "FBUT" => "Adventures of Lolo",
    "FBVJ" => "Tsuppari Oozumou",
    "FBWJ" => "Joy Mech Fight",
    "FBWQ" => "Joy Mech Fight",
    "FBXJ" => "Famicom Wars",
    "FBYE" => "Super Mario Bros. 2",
    "FBYJ" => "Super Mario USA",
    "FBYP" => "Super Mario Bros. 2",
    "FBYQ" => "Super Mario USA",
    "FBZE" => "Metroid",
    "FBZJ" => "Metroid",
    "FBZP" => "Metroid",
    "FC2J" => "Hanjuku Hero",
    ...
    "JBPJ" => "Super Donkey Kong 3 - Nazo no Krems Tou",
    ...
    "JBYP" => "Super R-Type",
    "JBYT" => "Super R-Type",
    "JC2J" => "Taikou Risshiden",
    "JC3J" => "Bahamut Lagoon",
    "JC4E" => "Indiana Jones' Greatest Adventures",
    "JC4J" => "Indiana Jones Great Adventure",
    "JC4P" => "Indiana Jones' Greatest Adventures",
    "JC5J" => "Romancing SaGa",
    "JC6J" => "Romancing SaGa 2",
    "JC7E" => "The Combatribes",
    "JC7J" => "The Combatribes",
    "JC8E" => "Final Fantasy II",
    "JC8J" => "Final Fantasy IV",
    ...
    "JCXJ" => "Super Nobunaga no Yabou - Zenkoku Ban",
    ...
    "JDAM" => "Final Fantasy III",
    "JDAP" => "Final Fantasy III",
    "JDBE" => "Super Bomberman 3",
    "JDCE" => "Street Fighter Alpha 2",
    "JDCJ" => "Street Fighter Two Alpha",
    "JDCP" => "Street Fighter Alpha 2",
    "JDDE" => "Final Fight 2",
    "JDDJ" => "Final Fight Two",
    "JDDP" => "Final Fight 2",
    "JDEE" => "Final Fight 3",
    "JDEJ" => "Final Fight Tough",
    "JDEP" => "Final Fight 3",
    "JDFJ" => "Sutte Hakkun",
    "JDHJ" => "Super Famicom Wars",
    ...
    "MA6J" => "Bare Knuckle II - Shitou he no Chinkonka",
    ...
    "MARE" => "Beyond Oasis",
    "MARJ" => "The Story of Thor - Hikari wo Tsugu Mono",
    ...
    "MCXJ" => "Dragon Slayer: The Legend of Heroes II",
    ...
    "PB3J" => "Devil Crash",
    "PB3P" => "Devil's Crush",
    "PB5J" => "Ninja Ryukenden",
    "PB6E" => "Cratermaze",
    "PB6P" => "Cratermaze",
    "PB7J" => "Sengoku Mahjong",
    "PB8E" => "Blazing Lazers",
    "PB8J" => "Blazing Lazers",
    "PB8P" => "Blazing Lazers",
    ...
    "PC8J" => "The Ninjawarriors",
    "PC9J" => "The NewZealand Story",
    ...
    "PCEP" => "Power Golf",
    "PCHE" => "Drop Off",
    "PCHJ" => "Drop Rock Hora Hora",
    "PCHP" => "Drop Off",
    "PCJJ" => "Override",
    "PCKJ" => "Gai Flame",
    "PCMC" => "Gokuraku! Chuuka Taisen",
    "PCMJ" => "Mr. Heli no Daibouken",
    "PCNJ" => "Winning Shot",
    "PCOE" => "Psychosis",
    "PCOJ" => "Paranoia",
    "PCOP" => "Psychosis",
    ...
    "EB2E" => "Real Bout Fatal Fury Special",
    ...
    "EBUP" => "2020 Super Baseball",
    "EBVJ" => "Shin-Oh-Ken",
    "EBWE" => "Sengoku",
    "EBWJ" => "Sengoku Denshou",
    "EBWP" => "Sengoku",
    "EBXE" => "Sengoku 2",
    "EBXJ" => "Sengoku Denshou 2",
    "EBXP" => "Sengoku 2",
    ...
    "E63J" => "Shinobi",
    "E63P" => "Shinobi",
    "E64J" => "Rolling Thunder 2",
    "E65J" => "Valkyrie no Densetsu",
    "E66J" => "Ordyne",
    "E67J" => "Dig Dug",
    "E68J" => "Galaga",
    "E69J" => "Baraduke",
    ...
    "HAJJ" => "Minna de Touhyou Channel",
    "HAJP" => "Everybody Votes Channel",
    "HAKC" => "Shǐyòng Xiéyì",
    "HAKE" => "User Agreements",
    "HAKJ" => "Riyou Kiyaku",
    "HAKK" => "Iyong Yaggwan",
    "HAKP" => "Agreement/Contact",
    "HALE" => "Region Select",
    "HALJ" => "Region Select",
    "HALK" => "Region Select",
    "HALP" => "Region Select",
    ...
    "HC4E" => "Crunchyroll",
    "HC4P" => "Crunchyroll",
    "HCAJ" => "Daigassou! Brand Brothers DX Senyou Speaker Channel",
    "HCAP" => "Jam with the Band Live Channel",
    "HCBJ" => "Photo Channel 1.0 Restore Program",
    "HCCJ" => "Address Settings",
    "HCDJ" => "Digital Camera Print Channel",
    "HCFE" => "Wii Speak Channel",
    "HCFJ" => "Wii Speak Channel",
    "HCFK" => "Wii Speak Channel",
    "HCFP" => "Wii Speak Channel",
    "HCGE" => "Wii + Internet",
    "HCGJ" => "Wii + Internet",
    "HCGP" => "Wii & the Internet",
    "HCGX" => "Wii & the Internet",
    "HCHJ" => "Demae Channel",
    "HCIJ" => "Wii no Ma",
    "HCJP" => "BBC iPlayer",
    "HCLE" => "Netflix instant streaming for Wii",
    "HCLP" => "Netflix",
    ...
    "HCTE" => "Wii System Transfer",
    "HCTJ" => "Wii System Transfer",
    "HCTP" => "Wii System Transfer",
    "HCUE" => "Wii Menu Electronic Manual",
    "HCUJ" => "Wii Menu Electronic Manual",
    "HCUP" => "Wii Menu Electronic Manual",
    "HCVA" => "Wii U Menu",
    "HCWE" => "Amazon Instant Video",
    "HCWP" => "Amazon LOVEFiLM Channel",
    "HCXE" => "YouTube",
    "HCXJ" => "YouTube",
    "HCXP" => "YouTube",
    "HCYE" => "Wii Menu Electronic Manual (Wii Mini)",
    "HCYJ" => "Wii U Main Unit Update Repair Program",
    "HCYP" => "Wii Menu Electronic Manual (Wii Mini)",
    "HFNJ" => "Wii Fit Karada Check Channel",
    "OSCW" => "Open Shop Channel",
    ...
    "RFPK" => "Wii Fit Plus Channel",
    "RFPP" => "Wii Fit Plus Channel",
    "RFPW" => "Wii Fit Plus Píndào",
    ...
    "WN64" => "Wii64",
    "WPSX" => "WiiSX",
    "XJSP" => "Karaoke Joysound Wii (Demo)",
    ...
    "DBZJ08" => "Biohazard Zero: Trial Edition",
    "DCEP41" => "Tom Clancy's Splinter Cell (Demo)",
    "DEZP8P" => "Billy Hatcher and the Giant Egg (Demo)",
    "DGAJB2" => "Kidou Senshi Gundam - Senshitachi no Kiseki Special Disc",
    ...
    "DM2J8P" => "Super Monkey Ball 2 (Demo)",
    "DNUEDA" => "Naruto Clash of Ninja 2 (Demo)",
    "DPIJ01" => "Pikmin (Demo)",
    "DPNP08" => "P.N.03 (Promo)",
    "DPOJ8P" => "Phantasy Star Online Episode I & II Trial Edition (Demo)",
    "DPSJ8P" => "Phantasy Star Online Episode III: C.A.R.D. Revolution (Demo)",
    "DR2JCQ" => "Rune II: Koruten no Kagi no Himitsu (Demo)",
    "DRSEAF" => "Soulcalibur II (Demo)",
    ...
    "G2DJB2" => "Digimon Battle Chronicle",
    ...
    "G3AJ13" => "Lord of the Rings - Nakatsu Kuni Daisanki",
    "G3AP69" => "The Lord of the Rings: The Third Age",
    "G3AS69" => "The Lord of the Rings: The Third Age",
    ...
    "G3ME41" => "Tom Clancy's The Sum of All Fears",
    ...
    "G4AJ99" => "Bokujou Monogatari - Shiawase no Uta",
    "G4BD08" => "Resident Evil 4",
    ...
    "G4GJ99" => "Bokujou Monogatari - Wonderful Life for Girls",
    ...
    "G4SJ01" => "The Legend of Zelda: Four Swords +",
    "G4SP01" => "The Legend of Zelda: Four Swords Adventures",
    "G4WJ99" => "Bokujou Monogatari - Shiawase no Uta for World",
    "G4ZE69" => "The Sims 2",
    "G4ZP69" => "The Sims 2",
    ...
    "G8WJ01" => "Totsugeki!! Famicom Wars",
    "G8WP01" => "Battalion Wars",
    "G94E01" => "Interactive Multi-Game Demo Disc - August 2002",
    "G95E01" => "Interactive Multi-Game Demo Disc - July 2002",
    "G96E01" => "Interactive Multi-Game Demo Disc - June 2002",
    "G96P01" => "Interactive Multi-Game Demo Disc - November 2002",
    "G97E01" => "Interactive Multi-Game Demo Disc - March 2002",
    "G97P01" => "Interactive Multi Game Demo Disc - September 2002",
    "G97U01" => "Interactive Multi-Game Demo Disc - September 2002",
    "G98E01" => "Interactive Multi-Game Demo Disc - January 2002",
    "G98P01" => "Interactive Multi-Game Demo Disc - May 2002",
    "G99E01" => "Interactive Multi-Game Demo Disc - October 2001",
    "G99P01" => "Interactive Multi-Game Demo Disc - March 2002",
    "G9BEE9" => "Mark Davis Pro Bass Challenge",
    "G9KJCM" => "Jikkyou Powerful Pro Yakyuu 9 - Ketteiban",
    "G9RD7D" => "Crash Tag Team Racing",
    "G9RE7D" => "Crash Tag Team Racing",
    "G9RF7D" => "Crash Tag Team Racing",
    "G9RH7D" => "Crash Tag Team Racing",
    "G9RJ7D" => "Crash Bandicoot Gacchanko World",
    ...
    "GABJB2" => "Konjiki no Gashbell!! Go! Go! Mamono Fight!!",
    ...
    "GAZD69" => "Harry Potter and the Prisoner of Azkaban",
    "GAZE69" => "Harry Potter and the Prisoner of Azkaban",
    "GAZF69" => "Harry Potter and the Prisoner of Azkaban",
    "GAZH69" => "Harry Potter and the Prisoner of Azkaban",
    "GAZI69" => "Harry Potter and the Prisoner of Azkaban",
    "GAZJ13" => "Harry Potter to Azkaban no Shuujin",
    "GAZM69" => "Harry Potter and the Prisoner of Azkaban",
    "GAZP69" => "Harry Potter and the Prisoner of Azkaban",
    "GAZS69" => "Harry Potter and the Prisoner of Azkaban",
    ...
    "GC8JA4" => "Crash Bandicoot: Bakusou! Nitro Kart",
    "GC9P6S" => "Conan",
    "GCAE5H" => "Cubix: Robots for Everyone Showdown",
    "GCBE7D" => "Crash Bandicoot: The Wrath of Cortex",
    "GCBJA4" => "Crash Bandicoot 4: Sakuretsu! Majin Power",
    ...
    "GCDJ08" => "Biohazard Code: Veronica Complete",
    ...
    "GCWJBL" => "Mahou no Pumpkin - An to Greg no Daibouken",
    "GCWP6X" => "Castleween",
    "GCZE69" => "Catwoman",
    "GCZP69" => "Catwoman",
    "GD4E6S" => "Dinotopia - The Sunstone Odyssey",
    "GD5JB2" => "Dragon Drive: D-Masters Shot",
    ...
    "GD9E69" => "Drome Racers",
    "GD9P69" => "Drome Racers",
    "GDAJE5" => "Doraemon Minna De Asobou!",
    "GDBJ01" => "Doubutsu Bancho",
    "GDCE51" => "Speed Kings",
    "GDCP51" => "Speed Kings",
    ...
    "GDEF71" => "Baldur's Gate: Dark Alliance",
    ...
    "GDLJA4" => "Disney Sports: Basketball",
    ...
    "GDUJA7" => "Duel Masters: Nettou! Battle Arena",
    "GDVE6L" => "Driven",
    "GDVP6L" => "Driven",
    "GDWEA4" => "Disney Sports Football",
    "GDWJA4" => "Disney Sports - American Football",
    ...
    "GEDW01" => "Eternal Darkness: Sanity's Requiem",
    "GEGJ8P" => "Billy Hatcher and the Giant Egg",
    "GEJJCM" => "Jikkyou Powerful Pro Yakyuu 11 Chou Ketteiban",
    "GEME7F" => "Egg Mania: Eggstreme Madness",
    "GEMJ28" => "Tsukande! Mawashite! Dossun Puzzle EggMania",
    "GEMP7F" => "Eggo Mania",
    ...
    "GEOJ08" => "Capcom vs. SNK 2 EO: Millionaire Fighting 2001",
    "GEOP08" => "Capcom vs. SNK 2 EO: Millionaire Fighting 2001",
    "GESEA4" => "Evolution Skateboarding",
    "GESJA4" => "Evolution Skateboarding",
    ...
    "GEXX52" => "Disney's Extreme Skate Adventure",
    "GEXY52" => "Disney Extreme Skate Adventure",
    "GEYE69" => "Fight Night Round 2",
    "GEYJ13" => "Fight Night Round 2",
    ...
    "GFJE69" => "FIFA Soccer 06",
    "GFKE69" => "Freekstyle",
    "GFKP69" => "Freekstyle",
    "GFMJAF" => "Family Stadium 2003",
    "GFNJG2" => "Finding Nemo",
    ...
    "GGNE5D" => "The Grim Adventures of Billy and Mandy",
    "GGPJAF" => "SD Gundam Gashapon Wars",
    "GGPJB2" => "SD Gundam Gashapon Wars",
    "GGRD41" => "Tom Clancy's Ghost Recon",
    ...
    "GH4J13" => "Harry Potter to Honoo no Goblet",
    ...
    "GHLJ13" => "Harry Potter to Kenja no Ishi",
    "GHLP69" => "Harry Potter and the Philosopher's Stone",
    "GHLX69" => "Harry Potter and the Philosopher's Stone",
    ...
    "GHSJ13" => "Harry Potter to Himitsu no Heya",
    ...
    "GIFJDQ" => "Generation of Chaos Exceed",
    ...
    "GIHF78" => "Scooby-Doo! Night of 100 Frights",
    "GIHP78" => "Scooby-Doo!: Night of 100 Frights",
    "GIIJ18" => "Momotarou Dentetsu 11",
    "GIJEFP" => "Space Raiders",
    "GIJJC0" => "Space Raiders",
    "GIJKC0" => "Space Raiders",
    "GIKE70" => "Ikaruga",
    "GIKJ70" => "Ikaruga",
    "GIKP70" => "Ikaruga",
    ...
    "GIOJCM" => "Jikkyou Powerful Pro Yakyuu 10 Chou Ketteiban - 2003 Memorial",
    ...
    "GJ2JCM" => "Jikkyou World Soccer 2002",
    ...
    "GJND78" => "Jimmy Neutron: Boy Genius",
    ...
    "GKLJ13" => "The Lord of the Rings: The Return of the King",
    ...
    "GKPJA4" => "Jikkyou Powerful Pro Yakyuu 12",
    "GKQJ01" => "Kururin Squash!",
    "GKREB2" => "Ribbit King",
    "GKRJB2" => "Kero Kero King DX",
    "GKRPB2" => "Ribbit King",
    ...
    "GKUE9G" => "Scaler",
    "GKWJ18" => "DreamMix TV World Fighters",
    "GKXJE7" => "Kiwame Mahjong DX2",
    "GKYE01" => "Kirby Air Ride",
    "GKYJ01" => "Kirby's Airride",
    ...
    "GLOD69" => "The Lord of the Rings: The Two Towers",
    "GLOE69" => "The Lord of the Rings: The Two Towers",
    "GLOF69" => "The Lord of the Rings: The Two Towers",
    "GLOI69" => "The Lord of the Rings: The Two Towers",
    "GLOJ13" => "Lord of the Rings - Futatsu no Tou",
    "GLOP69" => "The Lord of the Rings: The Two Towers",
    "GLOS69" => "The Lord of the Rings: The Two Towers",
    "GLQE41" => "Tom Clancy's Rainbow Six: Lockdown",
    "GLQP41" => "Tom Clancy's Rainbow Six: Lockdown",
    ...
    "GMTE69" => "Disney's Party",
    "GMTJ18" => "Disney no Magical Park",
    ...
    "GNDJ13" => "Need for Speed - Underground",
    ...
    "GONJ13" => "Medal of Honor: Europa Kyoushuu",
    ...
    "GPPJCM" => "Jikkyou Powerful Pro Yakyuu 9",
    ...
    "GQ4D78" => "SpongeBob SquarePants: Creature from the Krusty Krab",
    "GQ4E78" => "SpongeBob SquarePants: Creature from the Krusty Krab",
    "GQ4F78" => "SpongeBob SquarePants: Creature from the Krusty Krab",
    "GQ4H78" => "SpongeBob SquarePants: Creatuur van de Krokante Krab",
    ...
    "GQFFFK" => "Franklin: A Birthday Surprise",
    ...
    "GQWJ13" => "Harry Potter: Quidditch World Cup",
    ...
    "GRVEA4" => "Rave Master",
    "GRVJA4" => "Groove Adventure Rave - Fighting Live",
    ...
    "GT2J18" => "Tengai Makyou 2: Manji Maru",
    ...
    "GTFPA4" => "Teenage Mutant Ninja Turtles",
    "GTGE60" => "Top Gun: Combat Zones",
    "GTGJ1K" => "Top Gun - Ace of the Sky",
    ...
    "GUSJ28" => "Universal Studios Japan Adventure",
    ...
    "GVWJDQ" => "Gakuen Toshi Vara Noir Roses",
    ...
    "GWWJ01" => "Wario World",
    "GWWP01" => "Wario World",
    "GWXJ13" => "Star Wars Rogue Squadron III: Rebel Strike",
    ...
    "GXBP69" => "SSX 3",
    "GXCE01" => "Custom Robo",
    "GXCJ01" => "Custom Robo: Battle Revolution",
    "GXEE8P" => "Sonic Riders",
    "GXEJ8P" => "Sonic Riders",
    "GXEP8P" => "Sonic Riders",
    ...
    "GXXJ01" => "Pokémon XD: Yami no Kaze Dark Lugia",
    ...
    "GYKJB2" => "Konjiki no Gashbell!! Yuujou Tag Battle 2",
    "GYMJA4" => "Jikkyou Powerful Major League",
    ...
    "GYWDE9" => "Harvest Moon: A Wonderful Life",
    ...
    "GZFJBP" => "Gekituisenki - Zero Fighter",
    ...
    "PCKJ01" => "Pokémon Colosseum Kakuchou Disc (Bonus Disc)",
    "PCSJ01" => "Pokémon Colosseum Nintendo Tokusei Disc (Bonus Disc)",
    "PD5JB2" => "Dragon Drive: D-Masters Shot (Anime Disc)",
    "PGPJB2" => "SD Gundam Trial",
    "PGSJ01" => "Metal Gear Solid - The Twin Snakes - Special Disc",
    "PHEJ91" => "Homeland Test Disc",
    "PKBJ01" => "The Tower of Druaga",
    "PM4E01" => "Mario Kart: Double Dash!! Bonus Disc",
    "PNRJ01" => "Naruto Collection (Demo)",
    "PRJE01" => "Pac-Man vs.",
    "PRJJ01" => "Pac-Man vs.",
    "PRJP01" => "Pac-Man vs.",
