...
case $ARCH in
arm64)
  export CARGO_TARGET_AARCH64_UNKNOWN_LINUX_GNU_RUSTFLAGS="-C linker-plugin-lto -C link-arg=-fuse-ld=lld-21 -C link-arg=--target=aarch64-linux-gnu"
  ...
  ;;
armhf)
  export CARGO_TARGET_ARMV7_UNKNOWN_LINUX_GNUEABIHF_RUSTFLAGS="-C linker-plugin-lto -C link-arg=-fuse-ld=lld-21 -C link-arg=--target=arm-linux-gnueabihf"
  ...
  ;;
x86)
  export CARGO_TARGET_I686_UNKNOWN_LINUX_GNU_RUSTFLAGS="-C linker-plugin-lto -C link-arg=-fuse-ld=lld-21 -C link-arg=--target=i686-linux-gnu"
  ...
  ;;
x86_64)
  export CARGO_TARGET_X86_64_UNKNOWN_LINUX_GNU_RUSTFLAGS="-C linker-plugin-lto -C link-arg=-fuse-ld=lld-21 -C link-arg=--target=x86_64-linux-gnu"
  ...
  ;;
x86_64-v2)
  export CARGO_TARGET_X86_64_UNKNOWN_LINUX_GNU_RUSTFLAGS="-C linker-plugin-lto -C link-arg=-fuse-ld=lld-21 -C link-arg=--target=x86_64-linux-gnu -C target-cpu=x86-64-v2"
  export CARGO_TARGET_X86_64_UNKNOWN_LINUX_GNU_LINKER="clang-21"
  export CC_x86_64_unknown_linux_gnu="clang-21"
  export AR_x86_64_unknown_linux_gnu="llvm-ar-21"
  ...
  ;;
x86_64-v3)
  export CARGO_TARGET_X86_64_UNKNOWN_LINUX_GNU_RUSTFLAGS="-C linker-plugin-lto -C link-arg=-fuse-ld=lld-21 -C link-arg=--target=x86_64-linux-gnu -C target-cpu=x86-64-v3"
  export CARGO_TARGET_X86_64_UNKNOWN_LINUX_GNU_LINKER="clang-21"
  export CC_x86_64_unknown_linux_gnu="clang-21"
  export AR_x86_64_unknown_linux_gnu="llvm-ar-21"
