...
impl Language {
    pub fn flag(&self) -> ImageSource<'_> {
        match self {
            Language::En => include_image!("../../flag-icons/flags/4x3/gb.svg"),
            Language::Fr => include_image!("../../flag-icons/flags/4x3/fr.svg"),
            Language::De => include_image!("../../flag-icons/flags/4x3/de.svg"),
            Language::Es => include_image!("../../flag-icons/flags/4x3/es.svg"),
            Language::It => include_image!("../../flag-icons/flags/4x3/it.svg"),
            Language::Ja => include_image!("../../flag-icons/flags/4x3/jp.svg"),
            Language::Nl => include_image!("../../flag-icons/flags/4x3/nl.svg"),
            Language::Se => include_image!("../../flag-icons/flags/4x3/se.svg"),
            Language::Dk => include_image!("../../flag-icons/flags/4x3/dk.svg"),
            Language::No => include_image!("../../flag-icons/flags/4x3/no.svg"),
            Language::Ko => include_image!("../../flag-icons/flags/4x3/kr.svg"),
            Language::Pt => include_image!("../../flag-icons/flags/4x3/pt.svg"),
            Language::Zhtw => include_image!("../../flag-icons/flags/4x3/tw.svg"),
            Language::Zhcn => include_image!("../../flag-icons/flags/4x3/cn.svg"),
            Language::Fi => include_image!("../../flag-icons/flags/4x3/fi.svg"),
            Language::Tr => include_image!("../../flag-icons/flags/4x3/tr.svg"),
            Language::Gr => include_image!("../../flag-icons/flags/4x3/gr.svg"),
            Language::Ru => include_image!("../../flag-icons/flags/4x3/ru.svg"),
        }
    }
}
